        ...
        <section id="live-demo" className="py-24 bg-[#0a0a0c]">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 max-w-3xl mx-auto">
              <div className="text-xs text-[#1fddcb] font-semibold uppercase tracking-widest mb-4">INTERACTIVE DEMO</div>
              <h2 className="text-5xl font-bold font-heading text-white mb-4">
                Experience the <span className="text-[#1fddcb]">AI in Action</span>
              </h2>
              <p className="text-lg text-[#999]">
